...
public class GameOfLifeCell extends Cell {
    ...
    public GameOfLifeCell(int row, int col, int xCoor, int yCoor, int width, int height, int startingState) {
        ...
        this.cellFillColors = new Color[] {Color.WHITE, Color.BLACK}; // Colors should align will cell state number
        this.cellStrokeColors = new Color[] {Color.GREY, Color.GREY}; // Colors should align will cell state number
